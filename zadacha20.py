...
speech = input('Введите слово: ').upper()
if N == 1:
	print('За это слово вы получаете', sum([k for i in speech for k, v in english.items() if i in v]), 'очков')
elif N == 0:
	print('За это слово вы получаете', sum([k for i in speech for k, v in russian.items() if i in v]), 'очков')
